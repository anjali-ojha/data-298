...
""")
    ...
    with col1:
        col1.video("assets/sample/dog_playing.mp4")
    ...
    with col2:
        st.video("assets/sample/nike.mp4")
    ...
    with col3:
        st.video("assets/sample/smart_watch.mp4")
